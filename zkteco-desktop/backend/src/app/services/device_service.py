...
class ZkService:
    ...
    def _fetch_employee_details(self, users: list, external_api_domain: str) -> dict:
        ...
        try:
            ...
            app_logger.info(f"Fetching employee details for {len(users_array)} users from external API")
    ...
    def sync_employee(self, device_id: str = None):
        ...
        try:
            ...
            employee_details = self._fetch_employee_details(db_users, external_api_domain)
    ...
    def sync_all_users_from_external_api(self):
        ...
        try:
            ...
            app_logger.info(f"Fetching employee details for {len(all_users)} users from external API")
            employee_details = self._fetch_employee_details(all_users, external_api_domain)
